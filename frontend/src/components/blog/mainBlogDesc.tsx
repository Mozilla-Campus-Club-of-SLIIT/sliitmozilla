  ...
  return (
    <div className="h-full w-screen flex flex-row flex-wrap flex-wrap justify-center items-center p-2 md:p-12 gap-4">
      <Image
        ...
        height={100}
        alt="Mozilla Logo"
        className="cursor-pointer rounded-xl h-60 md:h-80 w-full md:w-2/6 drop-shadow-2xl shadow-inner shadow-2xl shadow-slate-00 select-none"
        unoptimized
      />
      <hr className="hidden md:block w-1 h-80 bg-gray-400 mx-8" />
      <div className="block md:hidden w-80 h-[1px] bg-gray-400 mx-2 "/>

      <div className="h-auto md:h-80 w-full md:w-3/6 md:p-4 md:m-2 p-2 flex flex-col justify-center items-center bg-white/10 backdrop-blur-lg rounded-xl shadow-lg border border-white/20">
